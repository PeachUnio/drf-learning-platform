...
class LessonsTestCase(APITestCase):
    ...
    def setUp(self):
        ...
        self.lesson = Lesson.objects.create(name="Тестовый урок 1", linc="youtube.com/test/1/", course=self.course,
                                            auth=self.user)
    ...
    def test_lesson_create(self):
        ...
        data = {
            "name": "Созданный урок 1",
            "linc": "youtube.com/create/1/"
        }
    ...
    def test_lesson_update(self):
        ...
        self.assertEqual(
            data.get("name"), "Воссозданный урок 1"
        )
